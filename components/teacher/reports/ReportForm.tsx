...
export default function ReportForm({ student, isHistoryView = false, initialData }: ReportFormProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <form onSubmit={handleSave} className="p-6 flex flex-col gap-8">
            ...
            <div className="flex items-center gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  ...
                  } ${!isHistoryView && rating < star ? "hover:text-orange-200" : ""} ${isHistoryView ? "cursor-default" : ""}`}
                >
        ...
        {testScores.length > 0 && testScores[0].subject !== "" && (
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              {testScores.map((test: any, index: number) => (
