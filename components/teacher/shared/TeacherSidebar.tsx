...
const sidebarLinks = [
  ...
  { name: "Profile", href: "/portal/teacher/profile", icon: User },
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="mt-auto px-3 pb-6">
        ...
        <Link
          href="/auth/login"
          className="flex items-center gap-3 px-3 py-2.5 mt-2 rounded-lg text-white/50 hover:text-red-400 hover:bg-red-500/10 text-sm font-medium transition-all"
        >
          <LogOut size={18} />
