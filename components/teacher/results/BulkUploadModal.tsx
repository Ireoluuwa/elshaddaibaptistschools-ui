      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-4 sm:p-6 overflow-y-auto">
            ...
            <div className="bg-[#e8fbf3] rounded-2xl p-4 sm:p-5 mb-6 sm:mb-8 border border-emerald-100">
              <div className="flex flex-col sm:flex-row items-start gap-4">
                ...
                <div className="w-full">
                  ...
                  <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-white text-emerald-700 text-xs font-bold rounded-lg border border-emerald-200 hover:bg-emerald-50 transition-colors shadow-sm">
                    <Download size={14} />
          ...
          <div className="p-4 border-t border-gray-100 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 bg-gray-50/50 shrink-0">
            ...
            <button 
              disabled={!file}
              className="w-full sm:w-auto px-6 py-2.5 text-sm font-bold text-white bg-[#65a990] hover:bg-[#528a75] disabled:opacity-50 disabled:cursor-not-allowed rounded-xl transition-colors shadow-sm"
            >
              Process Upload
            </button>
          </div>
