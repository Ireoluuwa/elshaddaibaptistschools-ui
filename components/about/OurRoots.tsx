        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <h2 className="text-primary dark:text-white text-3xl md:text-4xl font-black leading-tight">
                {rootsSection.title}
              </h2>
            </div>
            <div className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed flex flex-col gap-4">
          ...
          <div className="flex-1 w-full">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-8 border-white dark:border-green-900 rotate-2 hover:rotate-0 transition-transform duration-500">
              <img 
