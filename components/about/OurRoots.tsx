        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <h2 className="text-secondary text-xl md:text-4xl font-black leading-tight">
                {rootsSection.title}
              </h2>
            </div>
            <div className="text-gray-600 text-sm md:text-lg leading-relaxed flex flex-col gap-4">
